	...
	public static void execute(CommandContext<CommandSourceStack> arguments) {
		...
		if (DoubleArgumentType.getDouble(arguments, "attribute") == 1) {
			if ((new Object() {
				...
				_livingEntity2.getAttribute(RpgAttributeSystemModAttributes.ATTRIBUTE_1.get()).setBaseValue(1);
			...
			if ((new Object() {
				...
				_livingEntity5.getAttribute(RpgAttributeSystemModAttributes.ATTRIBUTE_2.get()).setBaseValue(1);
			...
			if ((new Object() {
				...
				_livingEntity8.getAttribute(RpgAttributeSystemModAttributes.ATTRIBUTE_3.get()).setBaseValue(1);
			...
			if ((new Object() {
				...
				_livingEntity11.getAttribute(RpgAttributeSystemModAttributes.ATTRIBUTE_4.get()).setBaseValue(1);
			...
			if ((new Object() {
				...
				_livingEntity14.getAttribute(RpgAttributeSystemModAttributes.ATTRIBUTE_5.get()).setBaseValue(1);
			...
			if ((new Object() {
				...
				_livingEntity17.getAttribute(RpgAttributeSystemModAttributes.ATTRIBUTE_6.get()).setBaseValue(1);
			...
			if ((new Object() {
				...
				_livingEntity20.getAttribute(RpgAttributeSystemModAttributes.ATTRIBUTE_7.get()).setBaseValue(1);
			...
			if ((new Object() {
				...
				_livingEntity23.getAttribute(RpgAttributeSystemModAttributes.ATTRIBUTE_8.get()).setBaseValue(1);
			...
			if ((new Object() {
				...
				_livingEntity26.getAttribute(RpgAttributeSystemModAttributes.ATTRIBUTE_9.get()).setBaseValue(1);
			...
			if ((new Object() {
				...
				_livingEntity29.getAttribute(RpgAttributeSystemModAttributes.ATTRIBUTE_10.get()).setBaseValue(1);
		}
	}
}
