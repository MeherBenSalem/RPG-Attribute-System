...
public class PlayerAttributesViewerGUIButtonMessage {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		RpgAttributeSystemModForge.addNetworkMessage(PlayerAttributesViewerGUIButtonMessage.class, PlayerAttributesViewerGUIButtonMessage::buffer, PlayerAttributesViewerGUIButtonMessage::new, PlayerAttributesViewerGUIButtonMessage::handler);
	}
}
