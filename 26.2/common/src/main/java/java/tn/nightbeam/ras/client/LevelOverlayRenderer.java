...
public class LevelOverlayRenderer {
    ...
    private static final Identifier XP_EMPTY = Identifier.tryParse(
            "rpg_attribute_system:textures/screens/rpg_attributes/slider_empty.png");
    private static final Identifier XP_FULL = Identifier.tryParse(
            "rpg_attribute_system:textures/screens/rpg_attributes/slider_full.png");
    ...
    public static void render(GuiGraphicsExtractor graphics, float partialTick) {
        ...
        if (showKeybind) {
            ...
            graphics.text(mc.font, keyText, drawX + BAR_WIDTH + 11, drawY + BAR_Y + 2, -1, false);
        }
        if (showXp) {
