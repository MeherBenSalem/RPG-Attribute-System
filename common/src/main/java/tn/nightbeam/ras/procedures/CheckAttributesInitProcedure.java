...
public class CheckAttributesInitProcedure {
	public static void execute(Entity entity) {
		...
		String directory = "";
		directory = "ras/attributes";
		if (Services.CONFIG.getBooleanValue(directory, "attribute_1", "lock")) {
		...
		if (Services.CONFIG.getBooleanValue(directory, "attribute_2", "lock")) {
		...
		if (Services.CONFIG.getBooleanValue(directory, "attribute_3", "lock")) {
		...
		if (Services.CONFIG.getBooleanValue(directory, "attribute_4", "lock")) {
		...
		if (Services.CONFIG.getBooleanValue(directory, "attribute_5", "lock")) {
		...
		if (Services.CONFIG.getBooleanValue(directory, "attribute_6", "lock")) {
		...
		if (Services.CONFIG.getBooleanValue(directory, "attribute_7", "lock")) {
		...
		if (Services.CONFIG.getBooleanValue(directory, "attribute_8", "lock")) {
		...
		if (Services.CONFIG.getBooleanValue(directory, "attribute_9", "lock")) {
		...
		if (Services.CONFIG.getBooleanValue(directory, "attribute_10", "lock")) {
