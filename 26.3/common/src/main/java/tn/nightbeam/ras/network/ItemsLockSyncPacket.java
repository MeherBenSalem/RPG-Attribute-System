...
public class ItemsLockSyncPacket {
    ...
    public static void encodeItemsLockData(FriendlyByteBuf buffer, boolean enabled, boolean showTooltip,
            List<String> itemsList) {
        encode(new ItemsLockSyncPacket(enabled, showTooltip, itemsList), buffer);
    }

    public static ItemsLockSyncPacket decodeItemsLockData(FriendlyByteBuf buffer) {
        return new ItemsLockSyncPacket(buffer);
    }
