...
Operator restrictions, NeoForge vs Forge jar selection, HUD/GUI text shadow, and attribute 11+ lock/icon behaviour. See `docs/listing-notes.md` for CurseForge/Modrinth reply text.
