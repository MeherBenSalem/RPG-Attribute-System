...
public class AttributeManager {
    ...
    /**
     * Get attribute icon Identifier from config.
     */
    public static net.minecraft.resources.Identifier getAttributeIconLocation(int attributeId) {
        ...
        if (iconPath != null && !iconPath.isEmpty()) {
            ...
            if (iconPath.contains(":")) {
                return net.minecraft.resources.Identifier.tryParse(iconPath);
            } else {
