...
public class PlayerAttributesViewerGUIScreen extends AbstractContainerScreen<PlayerAttributesViewerGUIMenu>
    ...
    public PlayerAttributesViewerGUIScreen(PlayerAttributesViewerGUIMenu container, Inventory inventory,
            Component text) {
        super(container, inventory, text, 234, 166);
    ...
    public void extractContents(GuiGraphicsExtractor guiGraphics, int mouseX, int mouseY, float partialTicks) {
        guiGraphics.blit(RenderPipelines.GUI_TEXTURED,
            Identifier.tryParse("rpg_attribute_system:textures/screens/bg2.png"), this.leftPos + -61,
                this.topPos + -21, 0, 0, 350, 210, 350, 210);
        if (ReturnDisplaySectionGenericProcedure.execute(1)) {
            guiGraphics.blit(RenderPipelines.GUI_TEXTURED,
                Identifier.tryParse("rpg_attribute_system:textures/screens/bg_attributes.png"),
        ...
        // Render widgets (buttons) and labels via vanilla pipeline
    ...
    @Override
        ...
        guiGraphics.text(this.font,
                ...
                -16777216, false);
        guiGraphics.text(this.font, ReturnCurrentLevelProcedure.execute(entity), 4, -1, -1, false);
        guiGraphics.text(this.font,
                Component.translatable("gui.rpg_attribute_system.player_attributes_viewer_gui.label_available_points"),
                124, 2, -16777216, false);
        guiGraphics.text(this.font, ReturnExtraPointsProcedure.execute(entity), 206, 2, -1, false);
        if (ReturnDisplaySectionGenericProcedure.execute(1))
            guiGraphics.text(this.font, ReturnSectionDisplayGenericProcedure.execute(entity, 1), -29, 24, -1,
                    false);
        if (ReturnDisplaySectionGenericProcedure.execute(2))
            guiGraphics.text(this.font, ReturnSectionDisplayGenericProcedure.execute(entity, 2), 79, 24, -1,
                    false);
        if (ReturnDisplaySectionGenericProcedure.execute(3))
            guiGraphics.text(this.font, ReturnSectionDisplayGenericProcedure.execute(entity, 3), 186, 24, -1,
                    false);
        if (ReturnDisplaySectionGenericProcedure.execute(4))
            guiGraphics.text(this.font, ReturnSectionDisplayGenericProcedure.execute(entity, 4), -29, 57, -1,
                    false);
        if (ReturnDisplaySectionGenericProcedure.execute(5))
            guiGraphics.text(this.font, ReturnSectionDisplayGenericProcedure.execute(entity, 5), 79, 57, -1,
                    false);
        if (ReturnDisplaySectionGenericProcedure.execute(6))
            guiGraphics.text(this.font, ReturnSectionDisplayGenericProcedure.execute(entity, 6), 186, 57, -1,
                    false);
        if (ReturnDisplaySectionGenericProcedure.execute(7))
            guiGraphics.text(this.font, ReturnSectionDisplayGenericProcedure.execute(entity, 7), -29, 89, -1,
                    false);
        if (ReturnDisplaySectionGenericProcedure.execute(8))
            guiGraphics.text(this.font, ReturnSectionDisplayGenericProcedure.execute(entity, 8), 79, 89, -1,
                    false);
        if (ReturnDisplaySectionGenericProcedure.execute(9))
            guiGraphics.text(this.font, ReturnSectionDisplayGenericProcedure.execute(entity, 9), 186, 89, -1,
                    false);
        if (ReturnDisplaySectionGenericProcedure.execute(10))
            guiGraphics.text(this.font, ReturnSectionDisplayGenericProcedure.execute(entity, 10), -29, 122, -1,
                    false);
        if (ReturnDisplaySectionGenericProcedure.execute(11))
            guiGraphics.text(this.font, ReturnSectionDisplayGenericProcedure.execute(entity, 11), 79, 122, -1,
                    false);
        if (ReturnDisplaySectionGenericProcedure.execute(12))
            guiGraphics.text(this.font, ReturnSectionDisplayGenericProcedure.execute(entity, 12), 186, 122, -1,
                    false);
        if (ReturnDisplaySectionGenericProcedure.execute(13))
            guiGraphics.text(this.font, ReturnSectionDisplayGenericProcedure.execute(entity, 13), -29, 154, -1,
                    false);
        if (ReturnDisplaySectionGenericProcedure.execute(14))
            guiGraphics.text(this.font, ReturnSectionDisplayGenericProcedure.execute(entity, 14), 79, 154, -1,
                    false);
        if (ReturnDisplaySectionGenericProcedure.execute(15))
            guiGraphics.text(this.font, ReturnSectionDisplayGenericProcedure.execute(entity, 15), 186, 154, -1,
                    false);
    }
