...
import tn.nightbeam.ras.procedures.OnOrbResetProcedure;
...
public class ScrollOfRebirthItem extends Item {
    public ScrollOfRebirthItem(String itemName) {
    ...
    public void appendHoverText(ItemStack itemstack, Item.TooltipContext context, TooltipDisplay tooltipDisplay,
        ...
        tooltipAdder.accept(Component.translatable("item.rpg_attribute_system.scroll_of_rebirth.description_0"));
    }
