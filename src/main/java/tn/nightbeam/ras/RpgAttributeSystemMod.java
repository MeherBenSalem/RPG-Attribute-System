...
public class RpgAttributeSystemMod {
	public static final Logger LOGGER = LogManager.getLogger(RpgAttributeSystemMod.class);
	public static final String MODID = "rpg_attribute_system";

	public RpgAttributeSystemMod(FMLJavaModLoadingContext context) {
		// Start of user code block mod constructor
		// End of user code block mod constructor
		MinecraftForge.EVENT_BUS.register(this);
		IEventBus bus = context.getModEventBus();

		RpgAttributeSystemModItems.REGISTRY.register(bus);

		RpgAttributeSystemModTabs.REGISTRY.register(bus);

		RpgAttributeSystemModMenus.REGISTRY.register(bus);
		RpgAttributeSystemModAttributes.REGISTRY.register(bus);
