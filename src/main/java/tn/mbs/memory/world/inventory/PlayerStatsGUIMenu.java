...
public class PlayerStatsGUIMenu extends AbstractContainerMenu implements MemoryOfThePastModMenus.MenuAccessor {
	...
	public PlayerStatsGUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(MemoryOfThePastModMenus.PLAYER_STATS_GUI.get(), id);
