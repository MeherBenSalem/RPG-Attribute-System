...
public class PlayerAttributesViewerGUIMenu extends AbstractContainerMenu implements MemoryOfThePastModMenus.MenuAccessor {
	...
	public PlayerAttributesViewerGUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(MemoryOfThePastModMenus.PLAYER_ATTRIBUTES_VIEWER_GUI.get(), id);
