package tn.mbs.memory;

import tn.mbs.memory.init.MemoryOfThePastModTabs;
...
@Mod("memory_of_the_past")
public class MemoryOfThePastMod {
	...
	public MemoryOfThePastMod(FMLJavaModLoadingContext context) {
		...
		MemoryOfThePastModItems.REGISTRY.register(bus);
