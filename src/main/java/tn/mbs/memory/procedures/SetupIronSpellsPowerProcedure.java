...
public class SetupIronSpellsPowerProcedure {
	public static void execute(CommandContext<CommandSourceStack> arguments) {
		...
		JaumlConfigLib.addStringToArray(dir, file, "cmd_to_exc", "/attribute @p irons_spellbooks:spell_power base set [param(0.02)]");
