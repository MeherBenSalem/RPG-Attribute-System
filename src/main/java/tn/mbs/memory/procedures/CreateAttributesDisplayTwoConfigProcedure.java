...
public class CreateAttributesDisplayTwoConfigProcedure {
	@SubscribeEvent
	...
	private static void execute(@Nullable Event event) {
		...
		if (!JaumlConfigLib.arrayKeyExists(dir, file, "display_name")) {
			JaumlConfigLib.setStringValue(dir, file, "display_name", "\u00A7fDamage \u00A7c\u2694 \u00A7f| \u00A7c");
		}
		...
		if (!JaumlConfigLib.arrayKeyExists(dir, file, "attribute_name")) {
			JaumlConfigLib.setStringValue(dir, file, "attribute_name", "generic.attack_damage");
		}
