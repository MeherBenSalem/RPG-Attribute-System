...
public class CreateAttributesDisplayForthConfigProcedure {
	@SubscribeEvent
	...
	private static void execute(@Nullable Event event) {
		...
		if (!JaumlConfigLib.arrayKeyExists(dir, file, "display_name")) {
			JaumlConfigLib.setStringValue(dir, file, "display_name", "\u00A7fArmor \u00A7b\uD83D\uDEE1 \u00A7f| \u00A7b");
		}
		...
		if (!JaumlConfigLib.arrayKeyExists(dir, file, "attribute_name")) {
			JaumlConfigLib.setStringValue(dir, file, "attribute_name", "generic.armor");
		}
