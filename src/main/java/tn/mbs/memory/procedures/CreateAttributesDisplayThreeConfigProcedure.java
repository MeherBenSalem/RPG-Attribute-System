...
public class CreateAttributesDisplayThreeConfigProcedure {
	@SubscribeEvent
	...
	private static void execute(@Nullable Event event) {
		...
		if (!JaumlConfigLib.arrayKeyExists(dir, file, "display_name")) {
			JaumlConfigLib.setStringValue(dir, file, "display_name", "\u00A7fAS \u00A7e\u231B \u00A7f| \u00A7e");
		}
		...
		if (!JaumlConfigLib.arrayKeyExists(dir, file, "attribute_name")) {
			JaumlConfigLib.setStringValue(dir, file, "attribute_name", "generic.attack_speed");
		}
